...
\section{Projects}
\cvline{}{\textbf{Smart Trashcan} \vfill
    \begin{itemize}
    \item 1st Place in 2016 HackPoly Hackathon
    \item Created a smart trashcan that detected when the trashcan was full which was displayed on a web application.
    \item Leveraged AWS technologies such as Amazon Echo to allow for voice controlled updates.
    \end{itemize}
    \vspace{-5mm}
}
